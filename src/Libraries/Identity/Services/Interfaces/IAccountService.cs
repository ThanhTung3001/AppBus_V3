...
namespace Identity.Services.Interfaces
{
    public interface IAccountService
    {
        ...
        Task<BaseResponse<object>>AuthenticateWithEmailAsync(AuthenticationRequestEmail request);

        Task<BaseResponse<AuthenticationResponse>>ValidationAuthCode (ValidationAuthCode request);

        Task<BaseResponse<object>>AuthenticateWithEmailGetCodeAsync(AuthenticationRequestEmail request);
    }
}
